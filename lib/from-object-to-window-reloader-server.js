module.exports = function (argv = process.argv.splice(2)) {
  ...
  const getParameters = require("./from-cli-args-to-map.js");
  const validateParameters = require("./from-schema-to-type-assertions.js");
  const startServer = require("./from-glob-watcher-to-socketio-emit.js");
